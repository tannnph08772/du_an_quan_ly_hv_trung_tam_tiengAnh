        ...
        <div class="col-md-6">
            ...
            <form action="{{route('user-savepass')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="curr_password" id="curr_password" class="form-control" value="">
                    @error('curr_password')
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="new_confirm_password" id="new_confirm_password" class="form-control" value="">
                ...
                <div class="row justify-content-center">
                    <div class="pr-2">
                        <a href="{{route('user.viewProfile')}}" class="btn btn-danger" type="submit">Quay lại</a>
                    </div>
                    <div>
