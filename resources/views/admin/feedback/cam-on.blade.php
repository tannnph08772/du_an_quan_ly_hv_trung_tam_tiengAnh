...
<div class="section-content"
    style="background: url('https://tienganhmoingay.com/media/images/uploads/2017/03/23/100-bi-ki-cai-thien-tieng-Anh-phan-2.jpg') no-repeat 0 0;background-size: cover;">
    <div class="bg-page">
        <div class="container">
            <div class="row">
                    ...
                    <div class="contactus-1 section-image page-header page-header-small">
                        <div class="container">
                            <div class="card card-contact no-transition">
                                <br><br>
                                <div style="width: 100px; height: 100px; margin-left: auto; margin-right: auto;"><img
                                        src="http://d1j8r0kxyu9tj8.cloudfront.net/files/1513314647HFqlwocqw2B3uZn.png">
                                </div>
                                <h3 class="card-title text-center" style="padding-bottom: 30px">Bạn đã góp ý thành
                                    công.
                                </h3>
                                <h5 class="text-center">Cảm ơn bạn đã đóng góp ý kiến của mình ! Alibaba sẽ chú ý và khắc phục những thiếu sót của mình !</h5> <br>
                                <a class="text-center" href="{{url('/')}}"><i class="fas fa-undo"></i> Nhấn để quay
                                    trang chủ</a> <br> <br>
                            </div>
                        </div>
                    </div>
